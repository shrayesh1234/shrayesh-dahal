...
function add_muhoortta_box(month, year) {
  ...
  if (year >= 2079 && year <= 2085) {
    json_url = 'https://bhupendra12345678.github.io/shrayesh-dahal/data/muhoortta.json';
  }
  else {
    console.warn("BS Year Range Invalid (Valid: 2079-2085) Given: ", year);
